...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'proffsbyggarna-leads' ),
				'storm'       => __( 'Storm or hail damage', 'proffsbyggarna-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'proffsbyggarna-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'proffsbyggarna-leads' ),
				'not-sure'    => __( 'Vet inte än', 'proffsbyggarna-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'proffsbyggarna-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'proffsbyggarna-leads' ),
				'research' => __( 'Jag kollar bara priser', 'proffsbyggarna-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'proffsbyggarna-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'proffsbyggarna-leads' ),
		'contacted' => __( 'Kontaktad', 'proffsbyggarna-leads' ),
		'quoted'    => __( 'Quote sent', 'proffsbyggarna-leads' ),
		'won'       => __( 'Won', 'proffsbyggarna-leads' ),
		'lost'      => __( 'Lost', 'proffsbyggarna-leads' ),
		'spam'      => __( 'Misstänkt spam', 'proffsbyggarna-leads' ),
	);
}
